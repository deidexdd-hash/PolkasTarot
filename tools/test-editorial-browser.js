...
const routes=['study','train','compare','stats','deck','modal','book','chapter','cards','lessons','pairs','courts','cases','lenormand','practices','layouts','guide','manual','reading','daily','mirror','journal','library','course','lesson','step','list','card-detail','linked-practice'];
(async()=>{
  ...
  try{
   ...
   for(const width of [320,390,768,1440]){
    ...
    for(const route of routes){
     ...
     if([390,1440].includes(width)&&['study','deck','modal','book','chapter','cards','layouts','reading','daily','journal','library','course','lesson','step','list','linked-practice'].includes(route)){
